...
<body>
    ...
    <main>
        <div>
            ...
            <p class='text-box'>Please fill in the details below to create your account. If you already have an account,
                you can <a href="login-dashboard.php">log in here</a>.</p>
        </div>
